		...
		switch(Node->TYPE){
			...
			case TYPE_VOID:
                                   ...
                                   if(temp!= NULL){
                                   		if(Node->left->middle==NULL){
                                   			...
                                   			*p = Evaluate(Node->right);	
                                   			...
                                   			x = Evaluate(Node->left->middle);
                                   			*(p+x)=Evaluate(Node->right);
				...
				case NODETYPE_READ: 
								...
								break;
				case NODETYPE_WRITE: printf("%d\n",Evaluate(Node->left)); break;
				case NODETYPE_IF: 
...
void check_if_bool(node *Node){

	switch(Node->TYPE){
		case TYPE_INT : 
					printf("Type mismatch, expected boolean given integer \n");
					exit(1);
					break;
		case TYPE_VOID : 
					printf("Type mismatch, expected boolean given void \n");
					exit(1);
					break;
		default: break;
	}
...
void check_if_int(node *Node){

	switch(Node->TYPE){
		case TYPE_BOOL : 
					printf("Type mismatch, expected integer given boolean \n");
					exit(1);
					break;
		case TYPE_VOID : 
					printf("Type mismatch, expected integer given void \n");
					exit(1);
					break;
		default : break;
	}
...
void typeCheck(node* n1, node* n2){
	if(n1->TYPE != n2->TYPE){
		printf("Type mismatch found \n");
					exit(1);
	}
}
